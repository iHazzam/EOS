    ...
    <div class="wrapper" id="root">
      ...
      <header class="main-header">
        ...
        <a href="{{ url('') }}" class="logo">
          ...
          <span class="logo-mini"><img src="{{url('storage/logo_5050.png')}}"></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><img src="{{url('storage/logo.png')}}"></span>
        </a>
      ...
      <footer class="main-footer">
        ...
        @endif
        &copy; <a target="_blank" href="{{ config('backpack.base.developer_link') }}">{{ config('backpack.base.developer_name') }}</a> {{date('Y')}}.
      </footer>
    </div>
    <!-- ./wrapper -->
