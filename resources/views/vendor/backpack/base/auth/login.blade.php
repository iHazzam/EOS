        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="box box-default">
                <div class="box-header with-border">
                    <div class="box-title logoholder">
                        <img class="logo-title col-lg-offset-4 col-md-offset-2 col-xs-offset-1 col-lg-4 col-md-8 col-xs-10" src="{{url('/storage/logo.png')}}">
                    </div>
                </div>
                <div class="box-body">
